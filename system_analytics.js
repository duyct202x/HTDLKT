...
const SystemAnalyticsManager = {
  ...
  daasPartners: [
    {
      partnerId: "PARTNER-SKHDT",
      name: "Sở Kế hoạch và Đầu tư tỉnh Khánh Hòa",
      apiScope: "API-01 (Kế hoạch ĐTC), API-02 (Dự án ngoài ngân sách), API-06 (FDI)",
      apiKey: "skhdt_kh_live_sec_8923487192",
  ...
  auditLogs: [
    { id: "LOG-98214", user: "Nguyễn Đình Hùng", dept: "Ban Giám đốc Sở", action: "Phê duyệt Báo cáo chỉ đạo điều hành theo Quyết định số 2071 quý III/2026", ip: "10.79.1.10", time: "2026-08-20 12:10:45", status: "SUCCESS" },
    { id: "LOG-98213", user: "Hệ thống tự động", dept: "Trung tâm CNTT và Dữ liệu kinh tế", action: "Đồng bộ tự động 09 API từ CSDL quốc gia Bộ Tài chính", ip: "127.0.0.1", time: "2026-08-20 12:00:00", status: "SUCCESS" },
    { id: "LOG-98212", user: "Lê Thị Thu Hằng", dept: "Phòng Quản lý Ngân sách", action: "Cập nhật số liệu thu nộp ngân sách Khatoco và Yến Sào Khánh Hòa", ip: "10.79.1.24", time: "2026-08-20 11:48:22", status: "SUCCESS" },
    { id: "LOG-98211", user: "Phạm Minh Tuấn", dept: "Phòng Quản lý Đầu tư", action: "Điều chỉnh tiến độ giải ngân dự án kè chống sạt lở sông Cái", ip: "10.79.1.35", time: "2026-08-20 11:30:10", status: "SUCCESS" },
    { id: "LOG-98210", user: "Trần Thanh Bình", dept: "Phòng Đầu tư ngoài Ngân sách", action: "Nạp Quyết định chấp thuận chủ trương đầu tư dự án DA-NNS-001", ip: "10.79.1.18", time: "2026-08-20 10:55:04", status: "SUCCESS" },
    ...
    container.innerHTML = `
      <div class="card-header">
        <div>
          ...
          <p class="card-subtitle">Tra cứu đồng thời trên 24 bảng CSDL và kho lưu trữ hơn 1 triệu trang tài liệu số hóa lịch sử</p>
        </div>
      </div>
          ...
          <div class="card" style="padding: 14px; background: #ffffff; display: flex; justify-content: space-between; align-items: center; border: 1px solid #e2e8f0;">
            <div>
              ...
              <div style="font-size: 11.5px; color: #475569; margin-top: 2px;">
                Số VB: <strong style="color: #0f172a;">${d.regNumber}</strong> • Vị trí: ${d.shelfLocation} • Liên kết CSDL: <span style="color: #15803d; font-weight: 600;">${d.mappedRecord}</span>
              </div>
            </div>
  ...
  renderEarlyWarningCenter(containerId) {
    ...
    container.innerHTML = `
      <div class="card-header">
        <div>
          <h3 class="card-title"><i data-lucide="alert-triangle"></i> Trung tâm giám sát và cảnh báo sớm kinh tế - tài chính</h3>
  ...
  renderDataIntegrityAndInteroperabilityView(containerId) {
    ...
    container.innerHTML = `
      ...
      <div class="domain-header-banner">
        <div class="banner-left">
          ...
          <div>
            <div class="banner-title">
              ...
              <span class="badge badge-success">Data Integrity 100% Passed</span>
            </div>
        ...
        <div>
          <button class="btn btn-primary btn-sm" onclick="App.showNotification('Đang quét kiểm tra toàn bộ 24 bảng MD và 23 bảng Fact...', 'info')">
            <i data-lucide="refresh-cw"></i> Quét ràng buộc real-time
          </button>
        </div>
      </div>

      <!-- 2. Bảng Ma Trận Liên Thông Giữa Các Phân Hệ Phòng Ban -->
      <div class="card" style="margin-bottom: 20px;">
        <div class="card-header">
          <div>
            <h3 class="card-title"><i data-lucide="git-merge"></i> Ma Trận Liên Thông Dữ Liệu Giữa Các Phòng Ban Sở Tài Chính</h3>
            <p class="card-subtitle">Minh chứng luồng dữ liệu tự động luân chuyển và thừa hưởng giữa các phân hệ nghiệp vụ không bị phân mảnh</p>
          </div>
          <span class="badge badge-purple">7 Luồng Nghiệp Vụ Liên Thông</span>
        </div>
        ...
        <div class="table-container">
          <table class="data-table">
            <thead>
              <tr>
                <th>Phân Hệ Nguồn (Gửi)</th>
                <th>Dữ Liệu Chia Sẻ / Liên Thông</th>
                <th>Phân Hệ Đích (Nhận)</th>
                <th>Mục Đích Nghiệp Vụ Sử Dụng</th>
                <th>Tần Suất Cập Nhật</th>
                <th>Trạng Thái Liên Thông</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td><strong style="color: #0284c7;">Phòng Kinh Tế & Ngân Sách</strong></td>
              ...
              <tr>
                ...
                <td><strong>Phòng Tài Chính HCSN</strong></td>
              ...
              <tr>
                ...
                <td><strong>Phòng Quản Lý Giá & Công Sản</strong></td>
                <td>Tự động ghi tăng nguyên giá tài sản kết cấu hạ tầng công của tỉnh</td>
                <td>Theo từng QĐ phê duyệt</td>
                <td><span class="badge badge-success"><i class="status-dot"></i> Đang liên thông</span></td>
              </tr>
              <tr>
                <td><strong style="color: #0284c7;">Phòng ĐT Ngoài Ngân Sách</strong></td>
              ...
              <tr>
                ...
                <td><strong>Phòng Kinh Tế & Ngân Sách</strong></td>
                <td>Hạch toán vào nguồn thu ngân sách cấp tỉnh theo Luật NSNN</td>
                <td>Hằng quý & Năm</td>
                <td><span class="badge badge-success"><i class="status-dot"></i> Đang liên thông</span></td>
              </tr>
              <tr>
                <td><strong style="color: #0284c7;">Phòng Quản Lý Giá & Công Sản</strong></td>
      ...
      <div class="dashboard-row">
        <div class="col-6">
          <div class="card" style="height: 100%;">
            <div class="card-header">
              <h3 class="card-title"><i data-lucide="check-circle-2"></i> Ràng Buộc Toàn Vẹn Nghiệp Vụ (Business Logic Constraints)</h3>
              <span class="badge badge-success">8/8 Passed</span>
            </div>
