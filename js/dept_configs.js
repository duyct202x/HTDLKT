...
const DEPT_CONFIGS = {
  'lanhdao': {
    ...
    stats: [
      ...
      { label: 'Giải ngân vốn đầu tư công', value: '7.850,4 tỷ đồng', unit: 'Đạt 68,38% kế hoạch vốn', trend: '+12,4%', icon: 'hard-hat', color: 'emerald' },
      { label: 'Vốn FDI thu hút lũy kế', value: '485,6 triệu USD', unit: '18 dự án cấp mới & tăng vốn', trend: '+15,1%', icon: 'globe', color: 'blue' },
  ...
  'ktns': {
    ...
    stats: [
      { label: 'Dự toán thu NSNN 2026', value: '18.100 tỷ đồng', unit: 'Chỉ tiêu HĐND giao', trend: 'Kế hoạch', icon: 'target', color: 'blue' },
      { label: 'Thực thu lũy kế', value: '18.520,6 tỷ đồng', unit: 'Vượt 420,6 tỷ đồng (102,3%)', trend: '+8,45%', icon: 'receipt', color: 'emerald' },
      { label: 'Thu từ DN trọng điểm', value: '8.340,5 tỷ đồng', unit: 'Khatoco, Yến Sào, Bia Sài Gòn', trend: '45,0% tổng thu', icon: 'award', color: 'blue' },
      { label: 'Tiến độ nộp báo cáo', value: '30 / 34 đơn vị', unit: '88,2% hoàn thành', trend: '4 đơn vị chờ', icon: 'list-checks', color: 'gold' }
    ],
    keyTaxPayers: [
  ...
  'dtc': {
    ...
    stats: [
      { label: 'Dự án trong kế hoạch', value: '186 dự án', unit: 'Tổng vốn: 11.480 tỷ đồng', trend: 'Đang theo dõi', icon: 'hard-hat', color: 'blue' },
      { label: 'Đã giải ngân lũy kế', value: '7.850,4 tỷ đồng', unit: '68,38% kế hoạch vốn', trend: '+6,2% tuần', icon: 'trending-up', color: 'emerald' },
      { label: 'Dự án trọng điểm tỉnh', value: '16 dự án', unit: 'Đường ven biển, cảng, kè', trend: 'Kế hoạch', icon: 'star', color: 'blue' },
  ...
  'dtns': {
    ...
    stats: [
      { label: 'Dự án đang theo dõi', value: '142 dự án', unit: 'Bao gồm 38 dự án FDI', trend: '+12 mới', icon: 'building-2', color: 'blue' },
      { label: 'Tổng vốn đăng ký', value: '86.450 tỷ đồng', unit: '3,45 tỷ USD quy đổi', trend: '+18,5%', icon: 'coins', color: 'blue' },
      { label: 'Dự án đang xây dựng', value: '48 dự án', unit: 'Đúng cam kết tiến độ', trend: 'Đúng tiến độ', icon: 'activity', color: 'emerald' },
      { label: 'Dự án chậm tiến độ', value: '9 dự án', unit: 'Cần đôn đốc xử lý', trend: 'Chậm tiến độ', icon: 'alert-triangle', color: 'rose' }
    ],
    projects: [
  ...
  'doanhnghiep': {
    ...
    stats: [
      { label: 'Doanh nghiệp hoạt động', value: '14.890 DN', unit: '+10,5% so với 2025', trend: '1.420 mới', icon: 'building', color: 'blue' },
      { label: 'Hợp tác xã & KT tập thể', value: '420 HTX', unit: '28 HTX thành lập mới', trend: 'Hiệu quả', icon: 'users', color: 'emerald' },
      { label: 'Báo cáo tài chính đã nạp', value: '11.240 BCTC', unit: '75,5% tổng số DN', trend: 'Thực hiện', icon: 'bar-chart-2', color: 'blue' },
  ...
  'giacongsan': {
    ...
    stats: [
      { label: 'Cơ sở nhà đất công', value: '1.840 cơ sở', unit: 'Trụ sở, trường học, y tế', trend: 'Danh mục', icon: 'home', color: 'blue' },
      { label: 'Đã phê duyệt sắp xếp', value: '1.420 cơ sở', unit: '77,17% tổng số cơ sở', trend: 'Đã duyệt', icon: 'check-square', color: 'emerald' },
      { label: 'Xe ô tô công toàn tỉnh', value: '312 chiếc', unit: 'Định mức: 320 xe', trend: 'Đúng định mức', icon: 'truck', color: 'blue' },
  ...
  'hcsn': {
    ...
    stats: [
      { label: 'Đơn vị sự nghiệp công lập', value: '542 đơn vị', unit: 'Giáo dục, y tế, văn hóa', trend: 'Danh mục', icon: 'graduation-cap', color: 'blue' },
      { label: 'Đơn vị tự chủ chi TX', value: '68 đơn vị', unit: 'Tiết kiệm ngân sách tỉnh', trend: 'Tiết kiệm NS', icon: 'trending-up', color: 'emerald' },
      { label: 'Kinh phí chi thường xuyên', value: '7.180 tỷ đồng', unit: 'Dự toán năm 2026', trend: 'Kế hoạch', icon: 'wallet', color: 'blue' },
      { label: 'Đã duyệt quyết toán năm', value: '495 / 542 đơn vị', unit: '91,3% tiến độ', trend: '47 đang thẩm tra', icon: 'check-circle', color: 'gold' }
    ],
    units: [
  ...
  'phapche': {
    ...
    stats: [
      { label: 'Quyết định xử phạt VPHC', value: '42 QĐ', unit: 'Tổng tiền phạt: 2.450 triệu đồng', trend: 'Thực hiện', icon: 'gavel', color: 'blue' },
      { label: 'Số tiền đã nộp phạt KBNN', value: '2.180 triệu đồng', unit: 'Thu hồi nộp NS: 89%', trend: 'Đúng tiến độ', icon: 'check-circle-2', color: 'emerald' },
      { label: 'Đơn thư khiếu nại, tố cáo', value: '28 đơn', unit: 'Đã xử lý: 26 đơn (92,8%)', trend: 'Đang xử lý', icon: 'clipboard-check', color: 'gold' },
      { label: 'Văn bản QPPL hệ thống hóa', value: '342 VB', unit: '186 NQ HĐND & 156 QĐ UBND', trend: 'Đang hiệu lực', icon: 'file-text', color: 'blue' }
    ],
    legalCases: [
  ...
  'vanphong': {
    ...
    stats: [
      { label: 'Hồ sơ lưu trữ hành chính', value: '88,5 mét giá', unit: '100% đã chỉnh lý & số hóa', trend: 'Lưu kho', icon: 'archive', color: 'blue' },
      { label: 'Văn bản xử lý trong năm', value: '4.820 văn bản', unit: '100% đúng hạn quy định', trend: '+14,2%', icon: 'file-text', color: 'emerald' },
      { label: 'Nhiệm vụ UBND tỉnh giao', value: '186 nhiệm vụ', unit: 'Đã hoàn thành 182 (97,8%)', trend: 'Đang xử lý', icon: 'check-circle-2', color: 'gold' },
      { label: 'Số hóa tài liệu chuyên ngành', value: '42.600 trang A4', unit: 'Bảo quản an toàn theo NĐ 30', trend: 'Tiêu chuẩn', icon: 'layers', color: 'blue' }
    ],
    documents: [
  ...
  'admin': {
    ...
    stats: [
      ...
      { label: 'Tổng dung lượng kho dữ liệu', value: '4,85 TB', unit: 'CSDL chủ MDM & Marts', trend: 'Sao lưu 04:00', icon: 'database', color: 'blue' },
      { label: 'Tài khoản đang truy cập', value: '48 cán bộ', unit: '15 phân hệ phân quyền RBAC', trend: 'Thực hiện', icon: 'users', color: 'blue' },
      { label: 'Bảo vệ dữ liệu cá nhân DDM', value: '100% tuân thủ', unit: 'Mã hóa CCCD & Tên đại diện', trend: 'Chuẩn NĐ 356', icon: 'shield-check', color: 'emerald' }
    ]
  },
  ...
  'portal_khatoco': {
    ...
    role: 'ENTERPRISE',
    stats: [
      { label: 'Nhiệm vụ báo cáo được giao', value: '1 báo cáo', unit: 'Báo cáo nộp NS & BCTC', trend: 'Đang mở', icon: 'clipboard-list', color: 'blue' },
      { label: 'Báo cáo đã hoàn thành', value: '3 báo cáo', unit: 'Các kỳ trước', trend: '100% đúng hạn', icon: 'check-circle-2', color: 'emerald' },
      { label: 'Thông báo từ Sở Tài chính', value: '0 thông báo', unit: 'Đã hoàn tất đối soát', trend: 'Bình thường', icon: 'message-square', color: 'blue' },
      { label: 'Hạn nộp kỳ tiếp theo', value: '15/09/2026', unit: 'Báo cáo dự toán 2027', trend: 'Còn 25 ngày', icon: 'clock', color: 'blue' }
    ]
  },
  ...
  'portal_maruha': {
    ...
    role: 'ENTERPRISE_FDI',
    stats: [
      { label: 'Nhiệm vụ báo cáo được giao', value: '1 báo cáo', unit: 'Giám sát tài chính FDI', trend: 'Đang mở', icon: 'clipboard-list', color: 'blue' },
      { label: 'Báo cáo đã hoàn thành', value: '2 báo cáo', unit: 'Các kỳ trước', trend: '100% đúng hạn', icon: 'check-circle-2', color: 'emerald' },
      { label: 'Thông báo từ Sở Tài chính', value: '0 thông báo', unit: 'Hồ sơ hợp lệ', trend: 'Bình thường', icon: 'message-square', color: 'blue' },
      { label: 'Hạn nộp kỳ tiếp theo', value: '30/09/2026', unit: 'Báo cáo năm 2026', trend: 'Còn 40 ngày', icon: 'clock', color: 'blue' }
    ]
  },
  ...
  'portal_loctho': {
    ...
    role: 'COMMUNE',
    stats: [
      { label: 'Nhiệm vụ báo cáo được giao', value: '2 kỳ báo cáo', unit: 'QĐ 2071 & Nhà đất công', trend: 'Đã hoàn thành', icon: 'clipboard-list', color: 'blue' },
      ...
      { label: 'Phản hồi từ Sở Tài chính', value: '1 thông báo', unit: 'Khớp đúng KBNN', trend: 'Đã xem', icon: 'message-square', color: 'blue' },
      { label: 'Hạn nộp kỳ tiếp theo', value: '25/09/2026', unit: 'Báo cáo quý III/2026', trend: 'Còn 35 ngày', icon: 'clock', color: 'blue' }
    ]
  },
  ...
  'portal_gts': {
    ...
    role: 'PROJECT_OWNER',
    stats: [
      { label: 'Nhiệm vụ báo cáo được giao', value: '1 báo cáo', unit: 'Giải ngân vốn ĐTC tháng 8', trend: 'Cần bổ sung', icon: 'clipboard-list', color: 'gold' },
      ...
      { label: 'Hạn nộp kỳ này', value: '30/08/2026', unit: 'Báo cáo tháng 8/2026', trend: 'Còn 8 ngày', icon: 'clock', color: 'blue' }
    ]
  },
  ...
  'portal_bvdakhoa': {
    ...
    role: 'HCSN_UNIT',
    stats: [
      { label: 'Nhiệm vụ báo cáo được giao', value: '1 báo cáo', unit: 'Tự chủ tài chính NĐ 60', trend: 'Chờ duyệt', icon: 'clipboard-list', color: 'gold' },
      ...
      { label: 'Hạn nộp kỳ tiếp theo', value: '10/09/2026', unit: 'Phương án 2026-2028', trend: 'Còn 20 ngày', icon: 'clock', color: 'blue' }
    ]
  },
  ...
  'portal': {
    ...
    role: 'ENTERPRISE',
    stats: [
      { label: 'Kỳ báo cáo được giao', value: '1 kỳ báo cáo', unit: 'Đang thu thập', trend: 'Cần hoàn thành', icon: 'clipboard-list', color: 'gold' },
      { label: 'Báo cáo đã duyệt', value: '3 báo cáo', unit: 'Đạt chuẩn chất lượng', trend: '100% đúng hạn', icon: 'check-circle-2', color: 'emerald' },
      { label: 'Phản hồi từ Sở Tài chính', value: '0 thông báo', unit: 'Hồ sơ đã duyệt', trend: 'Hoàn tất', icon: 'message-square', color: 'blue' },
      { label: 'Hạn nộp kỳ tiếp theo', value: '15/09/2026', unit: 'Báo cáo dự toán 2027', trend: 'Còn 25 ngày', icon: 'clock', color: 'blue' }
    ]
  }
};
