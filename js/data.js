  ...
  btcApis: [
    {
      ...
      fieldMappings: [
        ...
        { source: "MA_DB", target: "MA_DIA_BAN", type: "VARCHAR(20)", desc: "Mã địa bàn hành chính (Tỉnh/Huyện/Xã)" },
        { source: "MA_CNS", target: "MA_CAP_NS", type: "VARCHAR(10)", desc: "Mã cấp ngân sách (1: Tỉnh, 2: Huyện, 3: Xã)" },
    ...
    },
    {
      ...
      recordsSynced: 85,
      description: "Chia sẻ lớp dữ liệu không gian, ranh giới đồ án quy hoạch tỉnh theo QĐ 318/QĐ-TTg và quy hoạch sử dụng đất cấp huyện.",
      fieldMappings: [
  ...
  digitalArchive: [
    {
      ...
      extractedData: {
        ...
        "Địa điểm thực hiện": "Đảo Hòn Tre, phường Vĩnh Nguyên, TP. Nha Trang",
    ...
    },
    {
      ...
      title: "Hồ sơ Thẩm định & Phê duyệt Quyết toán Dự án Tuyến đường Vành đai 2 TP. Nha Trang",
      ...
      extractedData: {
        ...
        "Tên công trình": "Đường Vành đai 2 TP. Nha Trang (kết nối Nút giao thông Ngọc Hội)",
    ...
    },
    {
      ...
      title: "Hồ sơ Phương án sắp xếp lại, xử lý cơ sở nhà đất số 12 Hàn Thuyên, TP. Nha Trang",
